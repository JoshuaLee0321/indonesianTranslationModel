...
from scripts.ch2tl.New_CKIP import call_ckip
from scripts.ch2tl.bnp_by_con import make_NP,bnp_by_con
import hanlp
import pandas
import logging
import socket
...
tw = pandas.read_excel("scripts/ch2tl/output_abbr_without_embree_miniRev.xlsx")
tw2 = pandas.read_csv("scripts/ch2tl/ChhoeTaigi_KamJitian.csv")
twX = pandas.read_excel("scripts/ch2tl/output_MOE_2023_05_23.xlsx")
idioms = pandas.read_excel("scripts/ch2tl/idiom_tl.xlsx")
...
class tl_idiom_seg():
    def __init__(self,sentence) -> None:
        ...
        with open('scripts/ch2tl/idiom_dict.txt','r',encoding='utf-8') as dictionary: # load dictionary into mem
